...
Container::make( 'theme_options', __( 'Сoциальные сети' ) )
    ->add_fields( array(
        ...
        Field::make( 'text', 'name_obo_facebook', __( 'Facebook имя и фамилия с аккаунта' ) ),
        ...
        Field::make( 'text', 'name_obo_odnoklassniki', __( 'Odnoklassniki имя и фамилия с аккаунта' ) ),
        ...
        Field::make( 'text', 'name_obo_insta', __( 'Instagram имя и фамилия с аккаунта' ) ),
        ...
        Field::make( 'text', 'name_obo_google', __( 'Google имя и фамилия с аккаунта' ) ),
        ...
        Field::make( 'text', 'name_obo_yandex', __( 'Yandex имя и фамилия с аккаунта' ) ),
        ...
        Field::make( 'text', 'name_obo_twitter', __( 'Twitter имя и фамилия с аккаунта' ) ),
        ...
        Field::make( 'text', 'name_obo_vk', __( 'Vk имя и фамилия с аккаунта' ) ),
    ) );
